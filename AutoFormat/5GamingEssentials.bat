...
if %answer%==y (
cls
cd %userprofile%\Desktop\GamingEssentials
powershell -command Write-Host 3rd Phase: Gaming Essentials -fore Green
...
curl https://cdn-fastly.obsproject.com/downloads/OBS-Studio-28.0.1-Full-Installer-x64.exe -o OBS-Studio-28.0.1-Full-Installer-x64.exe
echo.
